          ...
          {products.map(p => (
            ...
            >
              ...
              <div className="relative  overflow-hidden bg-slate-800/50">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-tfrom-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </div>
